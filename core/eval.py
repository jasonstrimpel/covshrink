...
def run(runs=10, index=[15, 30, 50, 75, 100]):
    """Interface for the execution script
    
    Parameters
    ----------
    runs : number of runs to use to calculate the mean sample statistic
    index : list of benchmark index sizes to use
